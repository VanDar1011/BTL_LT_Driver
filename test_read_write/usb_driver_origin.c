...
static char file_input[MAX_FILENAME_LEN] = {0};
static char file_output[MAX_FILENAME_LEN] = {0};
//
...
static long device_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
    ...
    case IOCTL_DECRYPT:
        ...
        // Open output file
        outputcipher_file = filp_open(file_input, O_WRONLY | O_CREAT | O_TRUNC, 0644);
